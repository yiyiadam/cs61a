...
class PrimitiveProcedure(Procedure):
    ...
    def apply(self, args, env):
        ...
        try:
            ...
            raise SchemeError('Passed the wrong number of parapeters')
        # END PROBLEM 4
...
def do_and_form(expressions, env):
    ...
    if expressions == nil:
        ...
        if scheme_truep(scheme_eval(expressions.first,env)) == False:
            return False
        else:
